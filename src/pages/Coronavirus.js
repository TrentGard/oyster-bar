...
const Coronavirus = () => {
    return (
      <Container>
        ...
        <br />
        <h5 className="page-title"><span style={{ color: 'lightblue' }}>Update:</span> We are open! Check out our <span style={{ color: 'lightblue' }}>Daily Specials</span> tab above for the latest features!</h5>
